...
<div id="contentwrapper" class="contentwrapper">
	<div id="basicform" class="subcontent">
		...
		<form  id="form1" class="stdform " method="post">
			...
			<p>
				<label>执行语句或地址：</label>
				<span class="field"><textarea cols="80" rows="3" name="sqltext" id="sqltext" class="longinput" >${config.sqltext}</textarea></span>
			</p>

			<p>
				<label>回调语句或地址：</label>
				<span class="field"><textarea cols="80" rows="3" name="callbackid" id="callbackid" class="longinput">${config.callbackid}</textarea></span>
			</p>
